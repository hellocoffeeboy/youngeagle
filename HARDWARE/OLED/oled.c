...
void OLED_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC|RCC_APB2Periph_GPIOB, ENABLE);	 //Ê¹ÄÜB¶Ë¿ÚÊ±ÖÓ
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_10;	 
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //ÍÆÍìÊä³ö
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//ËÙ¶È50MHz
 	GPIO_Init(GPIOC, &GPIO_InitStructure);	  //³õÊ¼»¯GPIOC11
	
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_15;	 
 	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP; 		 //ÍÆÍìÊä³ö
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//ËÙ¶È50MHz
 	GPIO_Init(GPIOB, &GPIO_InitStructure);	  //³õÊ¼»¯GPIOC11
...
{
	OLED_ShowString(0,0,(u8*)"ANGLE:",12);
	OLED_ShowString(0,1,(u8*)"BAT :",12);
	OLED_ShowString(90,1,(u8*)"V",12);
	OLED_ShowString(60,2,(u8*)"R: ",12);	
	OLED_ShowString(1,2,(u8*)"L: ",12);
	OLED_ShowString(0,6,(u8*)"MODE :",12);
}
